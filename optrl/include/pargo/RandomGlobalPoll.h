#ifndef pargo_RandomGlobalPoll_h__guard
#define pargo_RandomGlobalPoll_h__guard
...
class RandomGlobalPoll : public Poll {
public:

    RandomGlobalPoll(const int populSize, const std::vector<BoundsPair> & bounds, double minDelta = 0.001);
