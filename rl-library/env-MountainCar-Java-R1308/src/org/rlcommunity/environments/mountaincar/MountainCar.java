...
public class MountainCar extends EnvironmentBase implements
    ...
    public Reward_observation_terminal env_step(Action theAction) {
        ...
        double a = theAction.doubleArray[0];
    ...
    public String env_message(String theMessage) {
        ...
        if (theMessageObject.getTheMessageType() == rlVizLib.messaging.environment.EnvMessageType.kEnvCustom.id()) {
            ...
            if (theCustomType.equals("GETMCSTATE")) {
                ...
                double lastAction = theState.getLastAction();
                double slope = theState.getSlope(position);
                MCStateResponse theResponseObject = new MCStateResponse((int)lastAction, position, velocity, height, slope);
